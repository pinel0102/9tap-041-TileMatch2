...
namespace I2.SmartEdge
{
    ...
    public class SE_AnimSequence
    {
        ...
        public virtual void OnStop(SmartEdge se, SE_Animation anim, int sequenceIndex)
        {
        }

        public virtual void InitTimes(SmartEdge se, SE_Animation anim, int sequenceIndex, int nElements)
        {
            switch (_StartType)
            {
        ...
        public virtual void UpdateSequence( float dt, SmartEdge se, SE_Animation anim, int sequenceIndex, ref bool makeMaterialDirty, ref bool makeVerticesDirty )
        {
        }

        public virtual void Apply_Characters(SmartEdge se, SE_Animation anim, int sequenceIndex)
        {
        }

        public virtual void Apply_Vertices(SmartEdge se, SE_Animation anim, int sequenceIndex)
        {
        }
        ...
        public float GetProgress( float time, SE_Animation anim, int characterID)
        {
            ...
            int nElements = SmartEdge.mCharacters.Size;
