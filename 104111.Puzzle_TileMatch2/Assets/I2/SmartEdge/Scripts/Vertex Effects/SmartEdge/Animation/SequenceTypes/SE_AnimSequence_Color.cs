...
namespace I2.SmartEdge
{
    ...
    public class SE_AnimSequence_Color : SE_AnimSequence
    {
        ...
        public bool _OnFinish_SetColorToFinalValue;  // When the animation finishes, sets the SmartEdge.color to the final value
        ...
        public override void Apply_Characters(SmartEdge se, SE_Animation anim, int sequenceIndex)
        {
            ...
            for (int iElement = mElementRangeStart; iElement < mElementRangeEnd; ++iElement)
            {
                ...
                var currentColor = SmartEdge.mOriginalVertices.Buffer[iElement * 4].color;
                ...
                for (int v=iElement*4; v<iElement*4+4; ++v)
                    SmartEdge.mOriginalVertices.Buffer[v].color = currentColor;
            }
        }
        ...
        public override void InspectorGUI()
        {
            ...
            _OnFinish_SetColorToFinalValue = GUILayout.Toggle(_OnFinish_SetColorToFinalValue, new GUIContent("On Finish: SetColorToFinalValue", "When the animation finishes, sets the SmartEdge.color to the final value"));
            GUILayout.Space(5);
