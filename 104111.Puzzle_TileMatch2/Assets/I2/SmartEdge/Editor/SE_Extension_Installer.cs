...
namespace I2.SmartEdge
{
    public class SE_Extension_Installer : EditorWindow
    {
        ...
        public void OnGUI()
        {
            ...
            foreach (var patch in PatchData)
            {
                ...
                if (patch.uiExpanded)
                {
                    ...
                    GUILayout.Label(patch.ExistingLine, "AS TextArea", GUILayout.ExpandHeight(false));
                    GUILayout.Label("New Line:");
                    GUILayout.Label(patch.NewLine, "AS TextArea", GUILayout.ExpandHeight(false));
                }
            ...
            GUILayout.BeginHorizontal();
                ...
                GUILayout.Label(ScriptingDefineSymbols, "AS TextArea", GUILayout.ExpandHeight(false));
        ...
        void EvaluatePatchStatus()
        {
            ...
            if (AllPatched)
                PatchResult = ExtensionName + " has been Patched to support SmartEdge";
            else
                PatchResult = string.Empty;
        }
        ...
        public void ApplyPatch()
        {
            ...
            {
                EvaluatePatchStatus();
                Debug.Log(ExtensionName + " has been Patched to support SmartEdge");
