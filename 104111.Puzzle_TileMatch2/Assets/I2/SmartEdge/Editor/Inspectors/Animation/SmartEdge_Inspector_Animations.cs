...
namespace I2.SmartEdge
{
	public partial class SmartEdge_Inspector
    {
        ...
        void OnGUI_Animation_AnimListElement(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            if (newAnimIdx != -1)
            {
                var path = SmartEdge_Inspector.GetI2SmartEdgePath() + "/Presets/Animations/" + mSavedAnimations[newAnimIdx] + ".asset";
        ...
        public void OnGUI_AnimationSlot()
        {
            ...
            if (prop_SlotPreset.objectReferenceValue != null && mSerializedObject_SelectedAnim!=null)
                GUITools.Editor_UpdateIfRequiredOrScript( mSerializedObject_SelectedAnim );
        ...
        void SaveAnimation(int index, string FileName = null)
        {
            ...
            {
                var mAnimPath = GetI2SmartEdgePath() + "/Presets/Animations/";
